...
export default function Characters() {
  ...
  let classOptions = ['Death Knight', 'Warrior', 'Paladin', 'Rogue', 'Hunter', 'Shaman', 'Druid', 'Mage', 'Priest', 'Warlock'];
  ...
  let columns = [
    ...
    type: 'singleSelect',
     ...
     valueOptions: raidTeams.map(team => {
      return {value: team.id, label: team.name}
    })},
    {field: 'name', headerName: 'Name', width: 200},
    {field: 'dkp', headerName: 'DKP', width: 75},
    {field: 'characterClass', type: 'singleSelect', headerName: 'Class', width: 75, editable: true, valueOptions: classOptions},
    {field: 'role', type: 'singleSelect', headerName: 'Role', width: 75, editable:true, valueOptions: roleOptions},
    {field: 'actions', headerName: 'Actions', width: 200, renderCell: params => actionButtons(params.row)}
  ];
